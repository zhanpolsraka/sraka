...
void make_relations(tInstrStack *st)
{
    for (int i = st->top; i > -1; i--)
    {
        ...
        {
            // zapiseme ukazatel na funkci do addr1
            instr->addr1 = search_func(instr->addr1, curr_class);
            // zapiseme ukazatel na nazev tridy do addr2
            instr->addr2 = &curr_class->key.str;
        }
